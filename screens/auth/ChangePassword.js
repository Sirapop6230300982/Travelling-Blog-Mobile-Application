  ...
  return (
    <SafeAreaView style={regStyles.container}>
      ...
      <View style={[{ flex: 3 }, regStyles.inputContainer]}>
        <AuthInput placeholder='old password' secureTextEntry={true} value={password.oldPass} onChangeText={(text) => setOldPass(text)} />
        <AuthInput placeholder='new password' secureTextEntry={true} value={password.newPass} onChangeText={(text) => setNewPass(text)} />
        <AuthInput placeholder='confirm new password' secureTextEntry={true} value={password.confirmPass} onChangeText={(text) => setConfirmPass(text)} />
        <TouchableOpacity
